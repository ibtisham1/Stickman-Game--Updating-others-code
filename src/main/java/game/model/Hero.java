...
public class Hero extends MovableEntityAbstraction implements Controllable {
     ...
     * and xVel
     */
    public Hero(String imagePath, double xPos, double yPos, double width, double height, double xVel, double score, Duration time) {
    ...
    public void increase(){
        //for(GameEngine m: GameEngineImplementation)
        //model.increaseScore();
    ...
    public double change(){
        ...
        //System.out.println(interval.toSeconds()-4);
        return score;
    }
